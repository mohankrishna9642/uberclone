...
public class Rideconfigration {
	...
	public ConsumerFactory<String,Ridedetails> consumerObject()
	{
		...
		dd.put(ConsumerConfig.GROUP_ID_CONFIG, "driver-data");
	dd.put(JsonDeserializer.TRUSTED_PACKAGES, "ubermain.model");
		

		return new DefaultKafkaConsumerFactory<String, Ridedetails>(dd);
	}
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String,Ridedetails> kafkalisterobj()
	{
		ConcurrentKafkaListenerContainerFactory<String, Ridedetails> bb= new ConcurrentKafkaListenerContainerFactory<String, Ridedetails>();
